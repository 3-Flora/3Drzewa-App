...
const Species = () => {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50 dark:bg-dark-bg transition-colors duration-200">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 dark:text-dark-text-secondary">Ładowanie gatunków...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 pt-8 lg:px-8 lg:py-8 bg-gray-50 dark:bg-dark-bg transition-colors duration-200">
      <motion.div
